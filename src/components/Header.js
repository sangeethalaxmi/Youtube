  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div className="col-span-10 text-center relative">
        <input
          type="text"
          className="border border-gray-300 w-4/5 p-2 px-4  rounded-l-full"
          value={searchQuery}
        ...
        />
        <button className="p-2 py-2 border border-gray-300 rounded-r-full bg-gray-100">
          Search
        </button>
        {showSuggestion && (
          <div className="border border-gray-100 absolute w-4/5 z-20 bg-white rounded-xl shadow-2xl left-[7%] ">
